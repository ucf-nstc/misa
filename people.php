<?php $pagetitle = "Collaborators"; require_once('includes/header.php'); ?>

<!-- People -->
<section class="container">
	<div class="row">
	<h1 class="col-md-12">Collaborators</h1>
		<div class="col-md-8">
			...
			<p><strong>Dr. Johnson</strong>, Plant Pathology</p>
			<p>Research Assistant Scientist, Citrus Research and Education Center, University of Florida</p>
			<p>Contact: <a href="mailto:egjohnson@ufl.edu">egjohnson@ufl.edu</a></p>
			<p><strong>Dr. Graham</strong>, Soil Microbiology</p>
			<p>Professor, Citrus Research and Education Center, University of Florida</p>
			<p>Contact: <a href="mailto:jhgraham@ufl.edu">jhgraham@ufl.edu</a></p>
			<p><strong>Dr. </strong><strong>Paret</strong>, Plant Pathology (Vegetables and Ornamentals)</p>
			<p>Assistant Professor, North Florida Research &amp; Education Center, University of Florida</p>
